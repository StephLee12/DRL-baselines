...
class DiscreteQMLPSingleOutput(nn.Module):
    def __init__(
        self,
        obs_dim,
        hidden_dim,
...
class DiscretePolicyMLPSingleOutput(nn.Module):
    def __init__(
        self,
        obs_dim,
        hidden_dim,
...
class DiscreteQMLPMultiOutput(nn.Module):
    pass 

class DiscretePolicyMLPMultiOutput(nn.Module):
    pass 

class ContinuousQMLPSingleOutput(nn.Module):
    def __init__(
        self,
        obs_dim,
        action_dim,
...
class ContinuousPolicyMLPSingleOutput(nn.Module):
    def __init__(
        self,
        obs_dim,
...
class ContinuousQMLPMultiOutput(nn.Module):
    pass 

class ContinuousPolicyMLPMultiOutput(nn.Module):
    pass 
