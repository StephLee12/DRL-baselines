...
class SACLag_GaussianContinuous():
    def __init__(
        ...
        self.policy = SAC_GaussianContinuousPolicyMultiActionSingleOutLayer(device=device, obs_dim=obs_dim, action_dim=action_dim, hidden_dim=hidden_dim, action_range=action_range, log_std_min=log_std_min, log_std_max=log_std_max).to(device)
